...
// export async function makeCommitOld(
//   versionChoice,
//   token,
//   repoFullName,
//   files,
...
//           Accept: "application/vnd..v3+json", // Correct header for  API
//         };

//         const baseUrl = `https://api..com/repos/${repoFullName}/contents/`;
//         const branch = "main";
//         const fileBlobs = [];
...
//           `https://api..com/repos/${repoFullName}/git/ref/heads/${branch}`,
//           { headers }
//         );
...
//           `https://api..com/repos/${repoFullName}/git/commits/${latestCommitSha}`,
//           { headers }
//         );
...
//           `https://api..com/repos/${repoFullName}/git/trees`,
//           {
//             method: "POST",
//             headers,
//             body: JSON.stringify({
...
//           `https://api..com/repos/${repoFullName}/git/commits`,
//           {
//             method: "POST",
//             headers,
//             body: JSON.stringify({
...
//           `https://api..com/repos/${repoFullName}/git/refs/heads/${branch}`,
//           {
//             method: "PATCH",
//             headers,
//             body: JSON.stringify({
...
//       } catch (error) {
//         console.error(
//           "An error occurred while committing files:",
//           error.message
//         );
//         throw error;
//       }
...
//           Accept: "application/vnd.gitlab.v4+json", // Correct header for GitLab API
//         };

//         const [namespace, project] = repoFullName.split("/");
//         const baseUrl = `https://gitlab.com/api/v4/projects/${encodeURIComponent(
//           namespace
//         )}%2F${encodeURIComponent(project)}`;
//         const branch = "main";

//         // Fetch the latest commit SHA for the branch
//         const branchResponse = await fetch(
//           `${baseUrl}/repository/branches/${branch}`,
//           { headers }
//         );
//         const branchData = await branchResponse.json();
//         if (!branchResponse.ok) {
//           throw new Error(`Failed to fetch branch: ${branchData.message}`);
//         }
//         const latestCommitSha = branchData.commit.id;

//         // Prepare the actions for the commit
...
//           return {
//             action: "update", // or 'create' if the file doesn't exist
...
//         const commitResponse = await fetch(`${baseUrl}/repository/commits`, {
//           method: "POST",
//           headers,
//           body: JSON.stringify({
//             branch,
...
//           Authorization: `Bearer ${token}`,
//           "Content-Type": "application/json",
//           Accept: "application/vnd.bitbucket.v2+json", // Correct header for Bitbucket API
//         };

//         const [workspace, repoSlug] = repoFullName.split("/");
//         const baseUrl = `https://api.bitbucket.org/2.0/repositories/${workspace}/${repoSlug}`;
//         const branch = "main";
...
//         if (!branchResponse.ok) {
//           throw new Error(
//             `Failed to fetch branch: ${branchData.error.message}`
//           );
//         }
//         const latestCommitSha = branchData.target.hash;

//         // Prepare the files to be committed
...
//         if (!commitResponse.ok) {
//           throw new Error(
//             `Failed to create commit: ${commitData.error.message}`
//           );
//         }

//         console.log(`Commit successfully created: ${commitData.hash}`);
//       } catch (error) {
//         console.error(
